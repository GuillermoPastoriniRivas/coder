            ...
            <Paper elevation={0} sx={{ p: { xs: 2, md: 4 }, borderRadius: 2, border: '1px solid', borderColor: 'divider' }}>
                ...
                <Box component="section" sx={{ mb: 5 }}>
                    ...
                    <Typography variant="body1" paragraph>
                        Welcome to Boostware! These terms and conditions outline the rules and regulations for the use of Boostware's Website, located at [Your Website URL].
                    </Typography>
                    <Typography variant="body1" paragraph>
                        By accessing this website we assume you accept these terms and conditions. Do not continue to use Boostware if you do not agree to take all of the terms and conditions stated on this page.
                    </Typography>
                    <Typography variant="subtitle1" gutterBottom>
                        1. License
                    </Typography>
                    <Typography variant="body2" paragraph>
                        Unless otherwise stated, Boostware and/or its licensors own the intellectual property rights for all material on Boostware. All intellectual property rights are reserved. You may access this from Boostware for your own personal use subjected to restrictions set in these terms and conditions.
                    </Typography>
                    <Typography variant="body2" paragraph>
                        You must not:
                        <ul>
                            <li>Republish material from Boostware</li>
                            <li>Sell, rent or sub-license material from Boostware</li>
                            <li>Reproduce, duplicate or copy material from Boostware</li>
                            <li>Redistribute content from Boostware</li>
                        </ul>
                    </Typography>
                     <Typography variant="subtitle1" gutterBottom>
                        2. User Comments
                     ...
                     <Typography variant="body2" paragraph>
                        Parts of this website offer an opportunity for users to post and exchange opinions and information. Boostware does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Boostware, its agents and/or affiliates. Comments reflect the views and opinions of the person who posts their views and opinions.
                     </Typography>
                     <Typography variant="subtitle1" gutterBottom>
                        3. Disclaimer
                    </Typography>
                ...
                <Box component="section">
                    ...
                    <Divider sx={{ mb: 2 }} />
                    <Typography variant="body1" paragraph>
                        Your privacy is important to us. It is Boostware's policy to respect your privacy regarding any information we may collect from you across our website, [Your Website URL], and other sites we own and operate.
                    </Typography>
                    <Typography variant="subtitle1" gutterBottom>
